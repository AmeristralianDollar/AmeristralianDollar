...
uint256 hashGenesisBlock("0x00517cdd32ee82097f1e739dcb83e3f8759c0ab657fb646f0edd5a3c9e073390");
static CBigNum bnProofOfWorkLimit = CBigNum().SetCompact(520503525); // AmeristralianDollar: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "AmeristralianDollar Signed Message:\n";
...
{
    // AmeristralianDollar: IsDust() detection disabled, allows any valid dust to be relayed.
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    nSubsidy >>= (nHeight / 8400000); // AmeristralianDollar: 840k blocks in ~4 years

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 302400; // AmeristralianDollar: 3.5 days
static const int64 nTargetSpacing = 150; // AmeristralianDollar: 2.5 minutes
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // AmeristralianDollar: This fixes an issue where a 51% attack can change difficulty at will.
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // AmeristralianDollar: Special short-term limits to avoid 10,000 BDB lock limit:
...
{
    // AmeristralianDollar: temporarily disable v2 block lockin until we are ready for v2 transition
    return false;
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x02787a41d8ec2062b59773047307f5577f528a1364a1529e30db3e11e64fc105");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "Ameristralian Dollar";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 10000000000;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("cb36ba36d35d463e40fad435e3eee673404a377f63812365860ca5d1395dfb3134ed9c96314505d3e2825e3bdc0ccdd1720e2564ed000aaef6ca47a43f920ad909") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1418564923;
        block.nBits    = 520503525;
        block.nNonce   = 422555156;

        if (fTestNet)
        {
            block.nTime    = 1418564923;
            block.nNonce   = 2235016308;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0xc6a3c7f4cd7e622bbb2702fd9daf2e5d0835145aa95fcf33ef94ea34335d15f4"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xfb, 0xc0, 0xb6, 0xdb }; // AmeristralianDollar: increase each by adding 2 to bitcoin's value.
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    //// debug print
    printf("AmeristralianDollar RPCMiner:\n");
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("AmeristralianDollarMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("AmeristralianDollarMiner : ProcessBlock, block not accepted");
    }
